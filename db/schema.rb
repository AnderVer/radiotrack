...
ActiveRecord::Schema[8.0].define(version: 2026_02_18_000012) do
  ...
  create_table "detections", force: :cascade do |t|
    ...
    t.index ["station_id", "played_at", "artist_title_normalized"], name: "index_detections_unique_station_played_artist_title", unique: true
